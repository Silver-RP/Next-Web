          ...
          <div className="row row-cols-lg-5 row-cols-2">
            <div className="footer-column footer-store-info col-12 mb-4 mb-lg-0">
              ...
              <p className="footer-address">
                123 Beach Avenue, Silver City, CA 00000
              </p>
              <p className="m-0">
                <strong className="fw-medium">contact@Silvermedia.in</strong>
              </p>
              <p>
        ...
        <div className="footer-bottom">
          <div className="container d-md-flex align-items-center">
            ...
            <div className="footer-settings d-md-flex align-items-center">
              <a href="privacy-policy.html" className="text-black">Privacy Policy</a> &nbsp;|&nbsp;{" "}
              <a href="terms-conditions.html" className="text-black">Terms &amp; Conditions</a>
            </div>
          </div>
        </div>
      </footer>
