...
if(document.getElementById('sort-select')){
  document.getElementById('sort-select').addEventListener('change', function(event) {
    ...
    if (sortValue == "2") {
        items.sort((a, b) => a.querySelector('.product-name').textContent.localeCompare(b.querySelector('.product-name').textContent));
    } else if (sortValue == "3") {
        items.sort((a, b) => b.querySelector('.product-name').textContent.localeCompare(a.querySelector('.product-name').textContent));
    } else if (sortValue == "4") {
        items.sort((a, b) => parseFloat(a.querySelector('.product-price').textContent) - parseFloat(b.querySelector('.product-price').textContent));
    } else if (sortValue == "5") {
        items.sort((a, b) => parseFloat(b.querySelector('.product-price').textContent) - parseFloat(a.querySelector('.product-price').textContent));
    }
...
(function () {
  ...
  //   window.location.href='.console.log("Product added to cart successfully");';
  // });


  if(document.querySelector('.js-show-register')){
